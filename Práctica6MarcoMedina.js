...
<body>
    <script>
        ...
        //===================================VIDEO 37=================================================//
        /*9)Programa una función que obtenga un número aleatorio 501 y 600*/
        ...
        positivo,se define como el producto de todos los número enteros positivos desde 1 hasta n),pe.miFuncion(5) devolverá 120
        */
        ...
        const convertirGrados = (grados = undefined, unidad = undefined) => {
            ...
            if (unidad === "C"){
                return console.info(`${grados}°C = ${Math.round((grados*(9/5))+32)}°C`);
            }
              else if (unidad === "F"){
                return console.info(`${grados}°F = ${Math.round(((grados-32)*(5/9)))}°C`); 
              }
                else{
                    return console.erro("El tipo de grados a convertir No es válido");
                }
       }
       convertirGrados();
       convertirGrados("2");
